...
class b {
    ...
    /* JADX INFO: renamed from: c.k.a.b$b, reason: collision with other inner class name */
    /* JADX INFO: compiled from: FocusStrategy.java */
    ...
    private static boolean a(int i2, Rect rect, Rect rect2, Rect rect3) {
        boolean zB = b(i2, rect, rect2);
        if (b(i2, rect, rect3) || !zB) {
            return false;
        }
    ...
    public static <L, T> T c(L l, InterfaceC0079b<L, T> interfaceC0079b, a<T> aVar, T t, Rect rect, int i2) {
        ...
        T t2 = null;
        int iB = interfaceC0079b.b(l);
        Rect rect3 = new Rect();
        for (int i3 = 0; i3 < iB; i3++) {
            T tA = interfaceC0079b.a(l, i3);
            if (tA != t) {
                aVar.a(tA, rect3);
