...
public final class a {
    ...
    private static final class C0089a {
        ...
        /* JADX INFO: renamed from: c.r.a$a$a, reason: collision with other inner class name */
        /* JADX INFO: compiled from: MultiDex.java */
        ...
        /* JADX INFO: renamed from: c.r.a$a$b */
        /* JADX INFO: compiled from: MultiDex.java */
        ...
        /* JADX INFO: renamed from: c.r.a$a$c */
        /* JADX INFO: compiled from: MultiDex.java */
        ...
        /* JADX INFO: renamed from: c.r.a$a$d */
        /* JADX INFO: compiled from: MultiDex.java */
        ...
        private C0089a() throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        ...
        static void a(ClassLoader classLoader, List<? extends File> list) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, IOException, SecurityException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            ...
            Object[] objArrB = new C0089a().b(list);
            try {
    ...
    private static void e(Context context, File file, File file2, String str, String str2, boolean z) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, IOException, SecurityException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        Set<File> set = a;
        synchronized (set) {
            ...
            try {
                ...
                c.r.b bVar = new c.r.b(file, fileJ);
                IOException e2 = null;
                try {
                    try {
                        l(classLoader, fileJ, bVar.k(context, str2, false));
                    } catch (IOException e3) {
                        if (!z) {
                            throw e3;
                        }
                        Log.w("MultiDex", "Failed to install extracted secondary dex files, retrying with forced extraction", e3);
                        l(classLoader, fileJ, bVar.k(context, str2, true));
                    }
                    try {
                        bVar.close();
    ...
    public static void k(Context context) {
        ...
        try {
            ...
            if (applicationInfoI == null) {
                ...
                e(context, new File(applicationInfoI.sourceDir), new File(applicationInfoI.dataDir), "secondary-dexes", HttpUrl.FRAGMENT_ENCODE_SET, true);
    ...
    private static void l(ClassLoader classLoader, File file, List<? extends File> list) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, InstantiationException, IOException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (list.isEmpty()) {
            return;
        }
        int i2 = Build.VERSION.SDK_INT;
