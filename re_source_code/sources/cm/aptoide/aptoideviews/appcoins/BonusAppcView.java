...
/* JADX INFO: compiled from: BonusAppcView.kt */
...
public final class BonusAppcView extends FrameLayout {
    ...
    private final Preferences retrievePreferences(AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, R.styleable.BonusAppcView, defStyleAttr, 0);
        m.e(typedArrayObtainStyledAttributes, "context.obtainStyledAttr…ppcView, defStyleAttr, 0)");
        Preferences preferences = new Preferences(typedArrayObtainStyledAttributes.getBoolean(R.styleable.BonusAppcView_enable_card_padding, true), Side.values()[typedArrayObtainStyledAttributes.getInt(R.styleable.BonusAppcView_side, 0)], Size.values()[typedArrayObtainStyledAttributes.getInt(R.styleable.BonusAppcView_size, 0)]);
