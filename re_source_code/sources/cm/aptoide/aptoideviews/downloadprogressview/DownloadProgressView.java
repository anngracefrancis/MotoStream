...
public final class DownloadProgressView extends FrameLayout {
    ...
    private final void retrievePreferences(AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, R.styleable.DownloadProgressView, defStyleAttr, 0);
        m.e(typedArrayObtainStyledAttributes, "context.obtainStyledAttr…essView, defStyleAttr, 0)");
        setProgressDrawable(typedArrayObtainStyledAttributes.getDrawable(R.styleable.DownloadProgressView_progressDrawable));
        setEnableAnimations(typedArrayObtainStyledAttributes.getBoolean(R.styleable.DownloadProgressView_enableAnimations, true));
        this.isPausable = typedArrayObtainStyledAttributes.getBoolean(R.styleable.DownloadProgressView_isPausable, true);
        String string = typedArrayObtainStyledAttributes.getString(R.styleable.DownloadProgressView_downloadingText);
        if (string == null) {
        ...
        String string2 = typedArrayObtainStyledAttributes.getString(R.styleable.DownloadProgressView_pausedText);
        if (string2 == null) {
        ...
        String string3 = typedArrayObtainStyledAttributes.getString(R.styleable.DownloadProgressView_installingText);
        if (string3 == null) {
    ...
    private final void setupClickListeners() {
        ((ImageView) _$_findCachedViewById(R.id.cancelButton)).setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.aptoideviews.downloadprogressview.b
            ...
            public final void onClick(View view) {
                DownloadProgressView.m1setupClickListeners$lambda0(this.f3724f, view);
            }
        });
        ((AnimatedImageView) _$_findCachedViewById(R.id.resumePauseButton)).setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.aptoideviews.downloadprogressview.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DownloadProgressView.m2setupClickListeners$lambda1(this.f3723f, view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setupClickListeners$lambda-0, reason: not valid java name */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setupClickListeners$lambda-1, reason: not valid java name */
    ...
    public final e<DownloadEventListener.Action> events() {
        e<DownloadEventListener.Action> eVarL = e.l(new DownloadProgressViewEventOnSubscribe(this));
        m.e(eVarL, "create(DownloadProgressViewEventOnSubscribe(this))");
        return eVarL;
    }
