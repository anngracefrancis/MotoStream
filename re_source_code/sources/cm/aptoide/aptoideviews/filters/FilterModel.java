...
/* JADX INFO: compiled from: FilterModel.kt */
...
public abstract class FilterModel extends t<CardHolder> {
    ...
    /* JADX INFO: renamed from: bind$lambda-3$lambda-0, reason: not valid java name */
        ...
        if (filter != null) {
            ...
            holder.getButton().setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.aptoideviews.filters.b
                ...
                public final void onClick(View view) {
                    FilterModel.m5bind$lambda3$lambda0(this.f3727f, filter, view);
                }
            });
