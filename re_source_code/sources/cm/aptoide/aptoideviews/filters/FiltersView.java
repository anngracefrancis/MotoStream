...
/* JADX INFO: compiled from: FiltersView.kt */
...
public final class FiltersView extends FrameLayout {
    ...
    public FiltersView(Context context, AttributeSet attributeSet, int i2) {
        ...
        ?? r3 = new FilterEventListener() { // from class: cm.aptoide.aptoideviews.filters.FiltersView$filterEventListener$1
            ...
            public void onFilterEvent(FilterEventListener.EventType eventType, Filter filter) {
                ...
                if (i3 == 2 && (iZ = c0.Z(this.this$0.filters, filter)) >= 0) {
                    ArrayList arrayList = new ArrayList(this.this$0.filters);
                    arrayList.set(iZ, new Filter(((Filter) this.this$0.filters.get(iZ)).getName(), true ^ ((Filter) this.this$0.filters.get(iZ)).getSelected(), ((Filter) this.this$0.filters.get(iZ)).getIdentifier()));
                    List<Filter> listE0 = c0.E0(arrayList);
                    this.this$0.setFilters(listE0);
                    ...
                    if (filtersChangedEventListener != null) {
                        filtersChangedEventListener.onFiltersChanged(listE0);
                    }
                }
            }
        };
    ...
    public final e<List<Filter>> filtersChangedEvents() {
        e<List<Filter>> eVarL = e.l(new FilterChangedEventOnSubscribe(this));
        m.e(eVarL, "create(FilterChangedEventOnSubscribe(this))");
        return eVarL;
    }
