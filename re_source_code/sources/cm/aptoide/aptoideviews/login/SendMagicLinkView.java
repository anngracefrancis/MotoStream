...
/* JADX INFO: compiled from: SendMagicLinkView.kt */
...
public final class SendMagicLinkView extends FrameLayout {
    ...
    /* JADX INFO: renamed from: getEmailChangeEvent$lambda-3, reason: not valid java name */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: getMagicLinkSubmit$lambda-2, reason: not valid java name */
    ...
    public final e<String> getEmailChangeEvent() {
        e eVarX = e.g.a.d.a.b((AutoCompleteTextView) _$_findCachedViewById(R.id.email)).X(new rx.m.e() { // from class: cm.aptoide.aptoideviews.login.b
            @Override // rx.m.e
            public final Object call(Object obj) {
                return SendMagicLinkView.m6getEmailChangeEvent$lambda3(this.f3730f, (d) obj);
            }
        });
        m.e(eVarX, "textChangeEvents(email)\n…{ email.text.toString() }");
        return eVarX;
    }

    public final e<String> getMagicLinkSubmit() {
        e eVarX = e.g.a.c.a.a((Button) _$_findCachedViewById(R.id.send_magic_link_button)).X(new rx.m.e() { // from class: cm.aptoide.aptoideviews.login.a
            @Override // rx.m.e
            public final Object call(Object obj) {
                return SendMagicLinkView.m7getMagicLinkSubmit$lambda2(this.f3729f, (Void) obj);
            }
        });
        m.e(eVarX, "clicks(send_magic_link_b…{ email.text.toString() }");
        return eVarX;
    }

    public final e<Void> getSecureLoginTextClick() {
        e<Void> eVarA = e.g.a.c.a.a((TextView) _$_findCachedViewById(R.id.login_benefits_textview));
        m.e(eVarA, "clicks(login_benefits_textview)");
        return eVarA;
    }
