...
/* JADX INFO: compiled from: AptoideSwipeRefresh.kt */
...
public final class AptoideSwipeRefresh extends c {
    ...
    private final void retrievePreferences(AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, R.styleable.AptoideSwipeRefresh, defStyleAttr, 0);
        m.e(typedArrayObtainStyledAttributes, "context.obtainStyledAttr…Refresh, defStyleAttr, 0)");
        setColors(typedArrayObtainStyledAttributes.getColor(R.styleable.AptoideSwipeRefresh_progressPrimaryColor, getResources().getColor(R.color.default_progress_bar_color)), typedArrayObtainStyledAttributes.getColor(R.styleable.AptoideSwipeRefresh_progressSecondaryColor, -1), typedArrayObtainStyledAttributes.getColor(R.styleable.AptoideSwipeRefresh_progressBackgroundColor, -1));
