...
/* JADX INFO: compiled from: ImageInfoProvider.kt */
...
public final class ImageInfoProvider {
    ...
    public final ImageInfo getInfo(String imagePath) {
        ...
        if (kotlin.text.u.r(uri != null ? uri.getScheme() : null, "content", false, 2, null)) {
            ...
            if (kotlin.text.u.r(uri != null ? uri.getScheme() : null, "file", false, 2, null)) {
                try {
