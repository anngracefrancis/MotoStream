...
public class LoginSignUpCredentialsFragment extends GooglePlayServicesFragment implements LoginSignUpCredentialsView, MagicLinkView, NotBottomNavigationView {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$googleSignUpEvent$1, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ Boolean e(Void r1) {
        return Boolean.valueOf(this.termsConditionsCheckBox.isChecked());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$googleSignUpEvent$2, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void f(Boolean bool) {
        this.accountAnalytics.clickIn(AccountAnalytics.StartupClick.CONNECT_GOOGLE, getStartupClickOrigin());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showAptoideLoginAreaClick$0, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ Boolean g(Void r1) {
        return Boolean.valueOf(this.termsConditionsCheckBox.isChecked());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showTermsConditionError$3, reason: merged with bridge method [inline-methods] */
    ...
    public void showTermsConditionError() {
        Snackbar snackbarA0 = Snackbar.a0(this.rootView, getString(R.string.signup_message_no_tandc_error), -1);
        if (getResources().getConfiguration().orientation == 1) {
            snackbarA0.p(new Snackbar.b() { // from class: cm.aptoide.pt.account.view.LoginSignUpCredentialsFragment.1
        ...
        if (constantState != null) {
            ...
            drawableMutate.setColorFilter(getResources().getColor(R.color.red), PorterDuff.Mode.SRC_ATOP);
