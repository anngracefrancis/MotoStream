...
/* JADX INFO: compiled from: AppCoinsAdvertisingModel.kt */
...
public final /* data */ class AppCoinsAdvertisingModel {
    ...
    public int hashCode() {
        int iA = x0.a(this.appcReward) * 31;
        boolean z = this.hasAdvertising;
        ?? r1 = z;
        if (z) {
            r1 = 1;
        }
        return ((((((((iA + r1) * 31) + x0.a(this.fiatReward)) * 31) + this.fiatCurrency.hashCode()) * 31) + x0.a(this.appcBudget)) * 31) + this.endDate.hashCode();
    }
