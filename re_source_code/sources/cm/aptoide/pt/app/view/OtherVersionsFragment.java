...
public class OtherVersionsFragment extends AptoideBaseFragment<BaseAdapter> {
    ...
    /* JADX INFO: renamed from: cm.aptoide.pt.app.view.OtherVersionsFragment$1, reason: invalid class name */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$fetchOtherVersions$0, reason: merged with bridge method [inline-methods] */
    ...
    protected void fetchOtherVersions() {
        this.endlessRecyclerOnScrollListener = new EndlessRecyclerOnScrollListener(getAdapter(), ListAppVersionsRequest.of(this.appPackge, StoreUtils.getSubscribedStoresAuthMap(this.storeRepository), this.baseBodyInterceptor, this.httpClient, this.converterFactory, ((AptoideApplication) getContext().getApplicationContext()).getTokenInvalidator(), ((AptoideApplication) getContext().getApplicationContext()).getDefaultSharedPreferences(), getContext().getResources()), new SuccessRequestListener() { // from class: cm.aptoide.pt.app.view.ag
            ...
            public final void call(Object obj) {
                this.f4209f.e((ListAppVersions) obj);
            }
