...
public final /* data */ class Download {
    ...
    public int hashCode() {
        int iA = ((((((((((((((((((cm.aptoide.pt.aab.a.a(this.appId) * 31) + this.appName.hashCode()) * 31) + this.packageName.hashCode()) * 31) + this.md5.hashCode()) * 31) + this.versionName.hashCode()) * 31) + this.versionCode) * 31) + this.icon.hashCode()) * 31) + this.path.hashCode()) * 31) + this.pathAlt.hashCode()) * 31) + cm.aptoide.pt.aab.a.a(this.size)) * 31;
        Obb obb = this.obb;
        int iHashCode = (((iA + (obb == null ? 0 : obb.hashCode())) * 31) + this.storeName.hashCode()) * 31;
        ...
        int iHashCode2 = (((((((((i2 + (z2 ? 1 : z2)) * 31) + this.malware.hashCode()) * 31) + this.splits.hashCode()) * 31) + this.requiredSplits.hashCode()) * 31) + this.oemId.hashCode()) * 31;
