...
/* JADX INFO: compiled from: DownloadViewStatusHelper.kt */
...
public final class DownloadViewStatusHelper {
    ...
    /* JADX INFO: renamed from: setupListeners$lambda-0, reason: not valid java name */
    ...
    public final void setupListeners(final Download download, final rx.s.b<DownloadClick> bVar, Button button, DownloadProgressView downloadProgressView) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.download.view.j0
            ...
            public final void onClick(View view) {
                DownloadViewStatusHelper.m110setupListeners$lambda0(bVar, download, view);
            }
        });
        downloadProgressView.setEventListener(new DownloadEventListener() { // from class: cm.aptoide.pt.download.view.DownloadViewStatusHelper.setupListeners.2
            ...
            /* JADX INFO: renamed from: cm.aptoide.pt.download.view.DownloadViewStatusHelper$setupListeners$2$WhenMappings */
            /* JADX INFO: compiled from: DownloadViewStatusHelper.kt */
            @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
            public /* synthetic */ class WhenMappings {
                public static final /* synthetic */ int[] $EnumSwitchMapping$0;
