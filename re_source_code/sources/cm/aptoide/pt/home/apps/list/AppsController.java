...
/* JADX INFO: compiled from: AppsController.kt */
...
public final class AppsController extends Typed3EpoxyController<List<? extends UpdateApp>, List<? extends InstalledApp>, List<? extends DownloadApp>> {
    ...
    public AppsController(ThemeManager themeManager) {
        ...
        b<AppClick> bVarG1 = b.g1();
        m.e(bVarG1, "create()");
        this.appEventListener = bVarG1;
        b<Void> bVarG2 = b.g1();
        m.e(bVarG2, "create()");
        this.updateAllEvent = bVarG2;
    }
    ...
    /* JADX INFO: renamed from: setData, reason: avoid collision after fix types in other method */
