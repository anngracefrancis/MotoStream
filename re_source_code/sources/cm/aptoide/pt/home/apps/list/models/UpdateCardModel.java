...
/* JADX INFO: compiled from: UpdateCardModel.kt */
...
public abstract class UpdateCardModel extends t<CardHolder> {
    ...
    private final void setupListeners(final CardHolder holder, final UpdateApp app) {
        holder.getActionButton().setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.apps.list.models.d
            ...
            public final void onClick(View view) {
                UpdateCardModel.m163setupListeners$lambda1(this.f5759f, app, view);
            }
        });
        holder.getItemView().setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.apps.list.models.e
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UpdateCardModel.m164setupListeners$lambda2(this.f5761f, app, view);
            }
        });
        holder.getItemView().setOnLongClickListener(new View.OnLongClickListener() { // from class: cm.aptoide.pt.home.apps.list.models.c
            ...
            public final boolean onLongClick(View view) {
                return UpdateCardModel.m165setupListeners$lambda3(this.f5757f, app, view);
            }
        });
        holder.getDownloadProgressView().setEventListener(new DownloadEventListener() { // from class: cm.aptoide.pt.home.apps.list.models.UpdateCardModel.setupListeners.4
            ...
            /* JADX INFO: renamed from: cm.aptoide.pt.home.apps.list.models.UpdateCardModel$setupListeners$4$WhenMappings */
            /* JADX INFO: compiled from: UpdateCardModel.kt */
            @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
            public /* synthetic */ class WhenMappings {
                public static final /* synthetic */ int[] $EnumSwitchMapping$0;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setupListeners$lambda-1, reason: not valid java name */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setupListeners$lambda-2, reason: not valid java name */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setupListeners$lambda-3, reason: not valid java name */
    ...
    public /* bridge */ /* synthetic */ void bind(q qVar, s sVar) {
        bind((CardHolder) qVar, (s<?>) sVar);
    }

    @Override // com.airbnb.epoxy.t, com.airbnb.epoxy.s
    public /* bridge */ /* synthetic */ void bind(Object obj, s sVar) {
        bind((CardHolder) obj, (s<?>) sVar);
    }
    ...
    public void bind(CardHolder cardHolder, s<?> sVar) {
