...
/* JADX INFO: compiled from: UpdateApp.kt */
...
public final /* data */ class UpdateApp implements StateApp {
    ...
    public int hashCode() {
        int iHashCode = ((((((((((((((((this.name.hashCode() * 31) + getMd5().hashCode()) * 31) + this.icon.hashCode()) * 31) + getPackageName().hashCode()) * 31) + getProgress()) * 31) + this.version.hashCode()) * 31) + getVersionCode()) * 31) + (getStatus() == null ? 0 : getStatus().hashCode())) * 31) + a.a(this.appId)) * 31;
