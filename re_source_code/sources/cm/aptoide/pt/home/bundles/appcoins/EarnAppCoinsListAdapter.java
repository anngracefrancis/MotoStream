...
/* JADX INFO: compiled from: EarnAppCoinsListAdapter.kt */
...
public final class EarnAppCoinsListAdapter extends RecyclerView.g<EarnAppCoinsItemViewHolder> {
    ...
    public EarnAppCoinsItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        m.f(parent, "parent");
        View viewInflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.earn_appcoins_item_home, parent, false);
        m.e(viewInflate, "from(parent.context)\n   …item_home, parent, false)");
