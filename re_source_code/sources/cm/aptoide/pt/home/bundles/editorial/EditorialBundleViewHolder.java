...
public class EditorialBundleViewHolder extends EditorialViewHolder {
    ...
    public EditorialBundleViewHolder(View view, rx.s.b<HomeEvent> bVar, CaptionBackgroundPainter captionBackgroundPainter, ThemeManager themeManager) {
        ...
        View viewFindViewById = view.findViewById(R.id.editorial_card);
        ...
        this.skeleton = SkeletonUtils.applySkeleton(viewFindViewById, (ViewGroup) view.findViewById(R.id.root_cardview), R.layout.editorial_action_item_skeleton);
    }
    ...
    /* JADX INFO: renamed from: lambda$setBundleInformation$0, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$setBundleInformation$1, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$setBundleInformation$2, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showReactions$3, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showReactions$4, reason: merged with bridge method [inline-methods] */
    ...
    private void setBundleInformation(String str, String str2, String str3, final String str4, final String str5, String str6, final int i2, final HomeBundle homeBundle, List<TopReaction> list, int i3, String str7, String str8, String str9, boolean z, int i4) {
        ...
        this.reactButton.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.editorial.d
            ...
            public final void onClick(View view) {
                this.f5906f.a(str4, str5, homeBundle, i2, view);
            }
        });
    ...
    public void showReactions(final String str, final String str2, final int i2) {
        ...
        reactionsPopup.setOnReactionsItemClickListener(new ReactionsPopup.OnReactionClickListener() { // from class: cm.aptoide.pt.home.bundles.editorial.e
            ...
            public final void onReactionItemClick(ReactionType reactionType) {
                this.a.d(str, str2, i2, reactionsPopup, reactionType);
            }
        });
        reactionsPopup.setOnDismissListener(new ReactionsPopup.OnDismissListener() { // from class: cm.aptoide.pt.home.bundles.editorial.b
            ...
            public final void onDismiss(ReactionsView reactionsView) {
                this.a.e(str, str2, i2, reactionsPopup, reactionsView);
            }
        });
    }
}
