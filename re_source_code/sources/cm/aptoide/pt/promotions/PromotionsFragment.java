...
public class PromotionsFragment extends NavigationTrackFragment implements PromotionsView {
    ...
    /* JADX INFO: renamed from: cm.aptoide.pt.promotions.PromotionsFragment$2, reason: invalid class name */
    ...
    private SpannableString handleRewardMessage(float f2, String str, double d2, boolean z) {
        ...
        if (z) {
            string = getString(R.string.FIATpromotion_update_to_get_short, string2, str + decimalFormat.format(d2));
        } else {
            string = getString(R.string.FIATpromotion_install_to_get_short, string2, str + decimalFormat.format(d2));
        }
        SpannableString spannableString = new SpannableString(string);
        spannableString.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.promotions_reward)), string.indexOf(string2), string.length(), 33);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$setWalletItemClickListener$13, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showPromotionOverDialog$11, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$14, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$15, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void h(PromotionViewApp promotionViewApp, View view) {
        this.promotionAppClick.onNext(new PromotionAppClick(promotionViewApp, PromotionAppClick.ClickType.PAUSE_DOWNLOAD));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$16, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$17, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$18, reason: merged with bridge method [inline-methods] */
    public /* synthetic */ void k(PromotionViewApp promotionViewApp, View view) {
        this.promotionAppClick.onNext(new PromotionAppClick(promotionViewApp, PromotionAppClick.ClickType.PAUSE_DOWNLOAD));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$19, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$20, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$showWallet$21, reason: merged with bridge method [inline-methods] */
    ...
    private void setClaimedButton() {
        ...
        Drawable drawableD = c.a.k.a.a.d(getContext(), R.drawable.ic_promotion_claimed_check);
    ...
    private void setWalletItemClickListener(final PromotionViewApp promotionViewApp) {
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.j1
            ...
            public final void onClick(View view) {
                this.f7072f.e(promotionViewApp, view);
            }
        };
    ...
    private void showWallet(final PromotionViewApp promotionViewApp, boolean z) {
        if (!promotionViewApp.getDownloadModel().isDownloading()) {
            ...
            TextView textView3 = (TextView) this.walletInactiveView.findViewById(R.id.app_reward);
            ...
            if (getState(promotionViewApp) == 5) {
                if (isWalletInstalled()) {
                    ...
                    this.promotionAction.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.b2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            this.f6999f.l(promotionViewApp, view);
                        }
                    });
                }
            ...
            if (getState(promotionViewApp) == 4) {
                ...
                this.promotionAction.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.o1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f7123f.m(promotionViewApp, view);
                    }
                });
            ...
            this.promotionAction.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.a2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f6989f.n(promotionViewApp, view);
                }
            });
            return;
        }
        ...
        TextView textView4 = (TextView) this.walletActiveView.findViewById(R.id.app_name);
        TextView textView5 = (TextView) this.walletActiveView.findViewById(R.id.app_reward);
        TextView textView6 = (TextView) this.walletActiveView.findViewById(R.id.app_description);
        ProgressBar progressBar = (ProgressBar) this.walletActiveView.findViewById(R.id.promotions_download_progress_bar);
        TextView textView7 = (TextView) this.walletActiveView.findViewById(R.id.promotions_download_progress_number);
        ...
        if (i2 == 1) {
            ...
            imageView3.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.y1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f7213f.g(promotionViewApp, view);
                }
            });
        ...
        if (i2 == 2) {
            ...
            imageView3.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.s1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f7162f.h(promotionViewApp, view);
                }
            });
            imageView4.setVisibility(8);
            imageView5.setVisibility(8);
        ...
        if (i2 != 3) {
            if (i2 != 4) {
                ...
                imageView3.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.u1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f7179f.k(promotionViewApp, view);
                    }
                });
                imageView4.setVisibility(8);
                imageView5.setVisibility(8);
        ...
        imageView4.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.k1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f7083f.i(promotionViewApp, view);
            }
        });
        ...
        imageView5.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.n1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f7112f.j(promotionViewApp, view);
            }
        });
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        View viewFindViewById = view.findViewById(R.id.promotion_wallet_inactive);
        this.walletInactiveView = viewFindViewById;
        this.promotionAction = (Button) viewFindViewById.findViewById(R.id.promotion_app_action_button);
        this.loading = (ProgressBar) view.findViewById(R.id.progress_bar);
        this.promotionsView = view.findViewById(R.id.promotions_view);
        View viewFindViewById2 = view.findViewById(R.id.generic_error);
        this.genericErrorView = viewFindViewById2;
        this.genericErrorViewRetry = viewFindViewById2.findViewById(R.id.retry);
    ...
    public void showPromotionOverDialog() {
        this.loading.setVisibility(8);
        View viewInflate = LayoutInflater.from(getContext()).inflate(R.layout.promotions_promotion_over_dialog, (ViewGroup) null);
        final AlertDialog alertDialogCreate = new AlertDialog.Builder(getContext()).setView(viewInflate).create();
        alertDialogCreate.setCancelable(false);
        viewInflate.findViewById(R.id.dismiss_button).setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.promotions.q1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f7142f.f(alertDialogCreate, view);
            }
        });
