...
public class RewardAppCoinsAppsRepository {
    ...
    /* JADX INFO: renamed from: lambda$getFreshAppCoinsRewardAppsFromHomeMore$0, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: lambda$getNextAppCoinsRewardAppsFromHomeMore$1, reason: merged with bridge method [inline-methods] */
    ...
    public e<List<RewardApp>> getFreshAppCoinsRewardAppsFromHomeMore(final String str) {
        return new GetAppCoinsCampaignsRequest(new GetAppCoinsCampaignsRequest.Body(0, 50), this.httpClient, this.converterFactory, this.bodyInterceptor, this.tokenInvalidator, this.sharedPreferences).observe(true).G(new rx.m.e() { // from class: cm.aptoide.pt.repository.request.a
            ...
            public final Object call(Object obj) {
                return this.f7248f.a(str, (ListAppCoinsCampaigns) obj);
            }
        });
    }
    ...
    public e<List<RewardApp>> getNextAppCoinsRewardAppsFromHomeMore(final String str) {
        int i2 = this.next;
        return i2 >= this.total ? e.S(Collections.emptyList()) : new GetAppCoinsCampaignsRequest(new GetAppCoinsCampaignsRequest.Body(i2, 50), this.httpClient, this.converterFactory, this.bodyInterceptor, this.tokenInvalidator, this.sharedPreferences).observe(false).G(new rx.m.e() { // from class: cm.aptoide.pt.repository.request.b
            @Override // rx.m.e
            public final Object call(Object obj) {
                return this.f7250f.b(str, (ListAppCoinsCampaigns) obj);
            }
        });
    }
}
