...
public class RootShell {
    ...
    /* JADX INFO: renamed from: cm.aptoide.pt.root.RootShell$5, reason: invalid class name */
    ...
    public static boolean exists(String str, boolean z) {
        ...
        try {
            ...
            arrayList.clear();
            Command command2 = new Command(objArr2 == true ? 1 : 0, objArr == true ? 1 : 0, new String[]{string + str}) { // from class: cm.aptoide.pt.root.RootShell.2
                @Override // cm.aptoide.pt.root.execution.Command
                public void commandOutput(int i2, String str2) {
                    RootShell.log(str2);
                    arrayList.add(str2);
