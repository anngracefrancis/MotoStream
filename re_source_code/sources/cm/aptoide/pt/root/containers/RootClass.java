...
public class RootClass {
    ...
    /* JADX INFO: renamed from: cm.aptoide.pt.root.containers.RootClass$1, reason: invalid class name */
    ...
    public static class AnnotationsFinder {
        ...
        protected File getBuiltPath() {
            ...
            if (file2.isDirectory()) {
                File[] fileArrListFiles = file2.listFiles(new FileFilter() { // from class: cm.aptoide.pt.root.containers.RootClass.AnnotationsFinder.2
                ...
                if (fileArrListFiles.length > 0) {
                    file = new File(file2.getAbsolutePath() + str + fileArrListFiles[0].getName());
                } else {
                    file = null;
                }
            } else {
    ...
    public RootClass(String[] strArr) throws IllegalAccessException, NoSuchMethodException, InstantiationException, ClassNotFoundException, InvocationTargetException {
        String str = strArr[0];
