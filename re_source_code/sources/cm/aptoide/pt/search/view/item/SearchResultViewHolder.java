...
/* JADX INFO: compiled from: SearchResultViewHolder.kt */
    ...
    private final void setAppInfo(final SearchAppResult result) {
        ...
        this.itemView.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.search.view.item.a
            ...
            public final void onClick(View view7) {
                SearchResultViewHolder.m311setAppInfo$lambda2(this.f7406f, result, view7);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: setAppInfo$lambda-2, reason: not valid java name */
