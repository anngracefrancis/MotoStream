...
public class StorePagerAdapter extends androidx.fragment.app.s implements NavigationTrackerPagerAdapterHelper {
    ...
    /* JADX INFO: renamed from: cm.aptoide.pt.store.view.StorePagerAdapter$1, reason: invalid class name */
    ...
    private void fillAvailableEventsMap(List<GetStoreTabs.Tab> list) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            if (!containsEventName(event.getName())) {
                this.availableEventsMap.put(event.getName(), Integer.valueOf(i2));
            }
        }
    }
