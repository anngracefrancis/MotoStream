...
public abstract class StoreTabGridRecyclerFragment extends GridRecyclerSwipeFragment {
    ...
    /* JADX INFO: renamed from: lambda$load$1, reason: merged with bridge method [inline-methods] */
    ...
    public void load(boolean z, boolean z2, Bundle bundle) {
        ...
        if (z || z2 || !hasDisplayables()) {
            ...
            if (StoreTabFragmentChooser.validateAcceptedName(this.name)) {
                rx.e<List<Displayable>> eVarBuildDisplayables = buildDisplayables(z2, strReplaceActionUrl, z2);
                if (eVarBuildDisplayables != null) {
                    eVarBuildDisplayables.f(bindUntilEvent(View.LifecycleEvent.DESTROY)).H0(new rx.m.b() { // from class: cm.aptoide.pt.store.view.r1
                        @Override // rx.m.b
