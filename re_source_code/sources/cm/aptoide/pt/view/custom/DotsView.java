...
public class DotsView extends View {
    ...
    private void updateOuterDotsPosition() {
        ...
        if (f2 < 0.3f) {
            ...
            double d2 = f2;
            float f3 = this.maxOuterDotsRadius;
            this.currentRadius1 = (float) AptoideUtils.MathU.mapValueFromRangeToRange(d2, 0.30000001192092896d, 1.0d, 0.8f * f3, f3);
        }
        float f4 = this.currentProgress;
        if (f4 < 0.7d) {
            this.currentDotSize1 = this.maxDotSize;
        } else {
            this.currentDotSize1 = (float) AptoideUtils.MathU.mapValueFromRangeToRange(f4, 0.699999988079071d, 1.0d, this.maxDotSize, 0.0d);
        }
    }
