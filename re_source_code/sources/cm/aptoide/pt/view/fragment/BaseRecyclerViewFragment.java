...
public abstract class BaseRecyclerViewFragment<T extends BaseAdapter> extends BaseLoaderToolbarFragment implements LifecycleSchim, DisplayableManager {
    ...
    public void setupViews() {
        ...
        RecyclerView.o oVarCreateLayoutManager = createLayoutManager();
        this.layoutManager = oVarCreateLayoutManager;
        this.recyclerView.setLayoutManager(oVarCreateLayoutManager);
