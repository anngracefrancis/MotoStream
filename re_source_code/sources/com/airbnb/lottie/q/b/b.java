...
public class b extends f<Integer> {
    ...
    public Integer i(com.airbnb.lottie.w.a<Integer> aVar, float f2) {
        ...
        int iIntValue2 = aVar.f8863c.intValue();
        com.airbnb.lottie.w.c<A> cVar = this.f8653e;
        return (cVar == 0 || (num = (Integer) cVar.b(aVar.f8865e, aVar.f8866f.floatValue(), Integer.valueOf(iIntValue), Integer.valueOf(iIntValue2), f2, e(), f())) == null) ? Integer.valueOf(com.airbnb.lottie.v.b.c(f2, iIntValue, iIntValue2)) : num;
    }
}
