...
public final class y {
    ...
    public static final boolean a(Context context, String str) {
        ...
        if (kotlin.text.u.E(str2, "generic", false, 2, null) && (i2 & 2) != 0) {
            return true;
        }
        try {
            ...
            for (Signature signature : signatureArr2) {
                ...
                if (!kotlin.collections.c0.K(hashSet, p0.E0(byteArray))) {
                    return false;
                }
            }
            return true;
