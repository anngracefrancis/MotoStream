...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    private void _writeSegmentASCII(int i2, int i3) throws IOException {
        char[] cArr;
        char c2;
        int[] iArr = this._outputEscapes;
        ...
        while (i4 < i2) {
            ...
            i4++;
            i_prependOrWriteCharacterEscape = _prependOrWriteCharacterEscape(this._outputBuffer, i4, i2, c2, i5);
        }
    }

    private void _writeSegmentCustom(int i2) throws IOException {
        char[] cArr;
        char c2;
        int i3;
        int[] iArr = this._outputEscapes;
        ...
        while (i5 < i2) {
            ...
            int i7 = i5 - i_prependOrWriteCharacterEscape;
            if (i7 > 0) {
                this._writer.write(cArr, i_prependOrWriteCharacterEscape, i7);
                if (i5 >= i2) {
                    return;
                }
            }
            i5++;
            i_prependOrWriteCharacterEscape = _prependOrWriteCharacterEscape(this._outputBuffer, i5, i2, c2, i3);
        }
    }
    ...
    private void _writeStringASCII(int i2, int i3) throws IOException {
        int i4;
        int i5;
        int i6;
        int i7;
        int i8 = this._outputTail + i2;
        int[] iArr = this._outputEscapes;
        int iMin = Math.min(iArr.length, i3 + 1);
    ...
    private void _writeStringASCII(char[] cArr, int i2, int i3, int i4) throws IOException {
        char c2;
        int i5 = i3 + i2;
        int[] iArr = this._outputEscapes;
        int iMin = Math.min(iArr.length, i4 + 1);
