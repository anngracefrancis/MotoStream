...
final class pt {
    ...
    static byte[] c(byte[] bArr, byte[] bArr2) {
        ...
        while (i4 < bArr2.length) {
            ...
            long jD6 = j10 + d(bArr3, 0, 0);
            long jD7 = j6 + d(bArr3, i2, 2);
            long jD8 = j7 + d(bArr3, 6, 4);
            long jD9 = j8 + d(bArr3, 9, 6);
            long jD10 = j9 + (d(bArr3, 12, 8) | ((long) (bArr3[16] << 24)));
            long j11 = (jD6 * jD) + (jD7 * j5) + (jD8 * j4) + (jD9 * j3) + (jD10 * j2);
            long j12 = (jD6 * jD2) + (jD7 * jD) + (jD8 * j5) + (jD9 * j4) + (jD10 * j3);
            long j13 = (jD6 * jD3) + (jD7 * jD2) + (jD8 * jD) + (jD9 * j5) + (jD10 * j4);
            long j14 = (jD6 * jD4) + (jD7 * jD3) + (jD8 * jD2) + (jD9 * jD) + (jD10 * j5);
            long j15 = j12 + (j11 >> 26);
            long j16 = j13 + (j15 >> 26);
            long j17 = j14 + (j16 >> 26);
            long j18 = (jD6 * jD5) + (jD7 * jD4) + (jD8 * jD3) + (jD9 * jD2) + (jD10 * jD) + (j17 >> 26);
        ...
        long jB = j47 + b(bArr, 16);
        long jB2 = j48 + b(bArr, 20) + (jB >> 32);
        long jB3 = j49 + b(bArr, 24) + (jB2 >> 32);
        long jB4 = ((((j45 >> 18) | (j46 << 8)) & 4294967295L) + b(bArr, 28) + (jB3 >> 32)) & 4294967295L;
        byte[] bArr4 = new byte[16];
        a(bArr4, jB & 4294967295L, 0);
        a(bArr4, jB2 & 4294967295L, 4);
        a(bArr4, jB3 & 4294967295L, 8);
        a(bArr4, jB4, 12);
        return bArr4;
    }
