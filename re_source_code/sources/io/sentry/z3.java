...
public final class z3 implements x3 {
    ...
    public u3 b(v1 v1Var, x4 x4Var) {
        ...
        if (strA != null && c(strA, x4Var.getLogger())) {
            return a(new j3(v1Var, x4Var.getEnvelopeReader(), x4Var.getSerializer(), x4Var.getLogger(), x4Var.getFlushTimeoutMillis()), strA, x4Var.getLogger());
        }
