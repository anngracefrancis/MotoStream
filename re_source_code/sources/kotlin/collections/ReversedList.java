...
/* JADX INFO: renamed from: kotlin.w.t0, reason: from Kotlin metadata */
...
final class ReversedList<T> extends AbstractMutableList<T> {
    ...
    public void add(int index, T element) {
        this.f25560f.add(a0.H(this, index), element);
    }
    ...
    @Override // kotlin.collections.AbstractMutableList
    public T f(int i2) {
        return this.f25560f.remove(a0.G(this, i2));
    }

    @Override // java.util.AbstractList, java.util.List
    public T get(int index) {
        return this.f25560f.get(a0.G(this, index));
    }

    @Override // java.util.AbstractList, java.util.List
    public T set(int index, T element) {
        return this.f25560f.set(a0.G(this, index), element);
    }
}
