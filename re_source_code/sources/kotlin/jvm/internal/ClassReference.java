...
/* JADX INFO: renamed from: kotlin.a0.d.e, reason: from Kotlin metadata */
...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    /* JADX INFO: renamed from: kotlin.a0.d.e$a */
    /* JADX INFO: compiled from: ClassReference.kt */
            ...
            if (!cls.isAnonymousClass()) {
                if (cls.isLocalClass()) {
                    ...
                    if (enclosingMethod != null) {
                        m.e(simpleName, "name");
                        String strG0 = v.G0(simpleName, enclosingMethod.getName() + '$', null, 2, null);
                        if (strG0 != null) {
                            return strG0;
                        }
                    }
                    ...
                    if (enclosingConstructor == null) {
                        m.e(simpleName, "name");
                        return v.F0(simpleName, '$', null, 2, null);
                    }
                    m.e(simpleName, "name");
                    return v.G0(simpleName, enclosingConstructor.getName() + '$', null, 2, null);
                }
                if (!cls.isArray()) {
    ...
    static {
        int i2 = 0;
        List listM = u.m(Function0.class, Function1.class, Function2.class, Function3.class, Function4.class, Function5.class, Function6.class, Function7.class, Function8.class, Function9.class, Function10.class, Function11.class, Function12.class, Function13.class, Function14.class, Function15.class, Function16.class, Function17.class, Function18.class, Function19.class, Function20.class, Function21.class, Function22.class);
        ArrayList arrayList = new ArrayList(kotlin.collections.v.u(listM, 10));
        ...
        m.e(collectionValues, "primitiveFqNames.values");
        for (String str : collectionValues) {
            StringBuilder sb = new StringBuilder();
            sb.append("kotlin.jvm.internal.");
            m.e(str, "kotlinName");
            sb.append(v.I0(str, '.', null, 2, null));
            sb.append("CompanionObject");
            Pair pairA = s.a(sb.toString(), str + ".Companion");
        ...
        f22940j = map3;
        LinkedHashMap linkedHashMap = new LinkedHashMap(p0.e(map3.size()));
        for (Map.Entry entry2 : map3.entrySet()) {
            linkedHashMap.put(entry2.getKey(), v.I0((String) entry2.getValue(), '.', null, 2, null));
        }
