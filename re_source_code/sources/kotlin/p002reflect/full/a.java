package kotlin.p002reflect.full;
...
public final class a {
    public static final <T> Collection<KProperty1<T, ?>> a(KClass<T> kClass) {
        m.f(kClass, "<this>");
        Collection<KCallableImpl<?>> collectionG = ((KClassImpl) kClass).Q().invoke().g();
    ...
    public static final <T> KFunction<T> b(KClass<T> kClass) {
        ...
        while (it.hasNext()) {
            ...
            y yVarF = ((KFunctionImpl) kFunction).F();
            m.d(yVarF, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ConstructorDescriptor");
            if (((l) yVarF).B()) {
