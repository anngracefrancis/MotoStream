...
public final class c {
    public static final <T> Constructor<T> a(KFunction<? extends T> kFunction) {
        Caller<?> callerZ;
        m.f(kFunction, "<this>");
        KCallableImpl<?> kCallableImplB = g0.b(kFunction);
        Member member = (kCallableImplB == null || (callerZ = kCallableImplB.z()) == null) ? null : callerZ.getMember();
    ...
    public static final Field b(KProperty<?> kProperty) {
        m.f(kProperty, "<this>");
        KPropertyImpl<?> kPropertyImplD = g0.d(kProperty);
        if (kPropertyImplD != null) {
            return kPropertyImplD.K();
        }
        return null;
    }
    ...
    public static final Type f(KType kType) {
        m.f(kType, "<this>");
        Type typeJ = ((KTypeImpl) kType).j();
        return typeJ == null ? w.f(kType) : typeJ;
    }
}
