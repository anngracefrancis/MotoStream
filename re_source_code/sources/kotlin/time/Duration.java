...
/* JADX INFO: renamed from: kotlin.i0.a, reason: from Kotlin metadata */
...
public final class Duration implements Comparable<Duration> {
    ...
    private static final long f25092h = c.e(4611686018427387903L);

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private static final long f25093i = c.e(-4611686018427387903L);

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private final long f25094j;

    /* JADX INFO: renamed from: kotlin.i0.a$a */
    /* JADX INFO: compiled from: Duration.kt */
    ...
    public static final int J(long j2) {
        ...
        return (int) (P(j2) ? c.g(M(j2) % ((long) 1000)) : M(j2) % ((long) Http2Connection.DEGRADED_PONG_TIMEOUT_NS));
    }
    ...
    public static String V(long j2) {
        ...
        boolean z2 = iA != 0;
        boolean z3 = I != 0;
        boolean z4 = (iK == 0 && iJ == 0) ? false : true;
        if (z) {
            sb.append(jD);
            sb.append('d');
            i2 = 1;
        ...
        if (z4) {
            ...
            if (iK != 0 || z || z2 || z3) {
                g(j2, sb, iK, iJ, 9, "s", false);
            } else if (iJ >= 1000000) {
                g(j2, sb, iJ / 1000000, iJ % 1000000, 6, "ms", false);
            } else if (iJ >= 1000) {
                g(j2, sb, iJ / 1000, iJ % 1000, 3, "us", false);
            } else {
                sb.append(iJ);
                sb.append("ns");
            }
    ...
    private static final void g(long j2, StringBuilder sb, int i2, int i3, int i4, String str, boolean z) {
        ...
        if (i3 != 0) {
            sb.append('.');
            String strG0 = v.g0(String.valueOf(i3), i4, '0');
            int i5 = -1;
            ...
            int i7 = i5 + 1;
            if (z || i7 >= 3) {
                sb.append((CharSequence) strG0, 0, ((i7 + 2) / 3) * 3);
    ...
    public static long v(long j2) {
        if (b.a()) {
            if (Q(j2)) {
                ...
                if (!new LongRange(-4611686018427387903L, 4611686018427387903L).i(M(j2))) {
