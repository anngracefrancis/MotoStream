...
public final class c {
    ...
    public static final long d(long j2, int i2) {
        return Duration.v((j2 << 1) + ((long) i2));
    }
    ...
    public static final long h(int i2, DurationUnit durationUnit) {
        ...
        return durationUnit.compareTo(DurationUnit.SECONDS) <= 0 ? f(e.b(i2, durationUnit, DurationUnit.NANOSECONDS)) : i(i2, durationUnit);
    }

    public static final long i(long j2, DurationUnit durationUnit) {
        m.f(durationUnit, "unit");
        DurationUnit durationUnit2 = DurationUnit.NANOSECONDS;
        long jB = e.b(4611686018426999999L, durationUnit2, durationUnit);
        return new LongRange(-jB, jB).i(j2) ? f(e.b(j2, durationUnit, durationUnit2)) : e(l.g(e.a(j2, durationUnit, DurationUnit.MILLISECONDS), -4611686018427387903L, 4611686018427387903L));
    }
}
