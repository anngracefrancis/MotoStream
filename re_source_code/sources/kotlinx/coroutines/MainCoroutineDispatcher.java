...
/* JADX INFO: renamed from: kotlinx.coroutines.i2, reason: from Kotlin metadata */
...
public abstract class MainCoroutineDispatcher extends CoroutineDispatcher {
    ...
    protected final String W() {
        ...
        if (this == mainCoroutineDispatcherC) {
            return "Dispatchers.Main";
        }
        try {
            mainCoroutineDispatcherT = mainCoroutineDispatcherC.T();
        } catch (UnsupportedOperationException unused) {
            mainCoroutineDispatcherT = null;
        }
        if (this == mainCoroutineDispatcherT) {
