...
public final class a {
    private static final void a(Continuation<?> continuation, Throwable th) throws Throwable {
        Result.a aVar = Result.f25108f;
        continuation.resumeWith(Result.a(o.a(th)));
        throw th;
    }

    public static final void b(Continuation<? super u> continuation, Continuation<?> continuation2) throws Throwable {
        try {
            Continuation continuationB = c.b(continuation);
            Result.a aVar = Result.f25108f;
            i.c(continuationB, Result.a(u.a), null, 2, null);
        } catch (Throwable th) {
            a(continuation2, th);
        }
    }

    public static final <R, T> void c(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation, Function1<? super Throwable, u> function1) throws Throwable {
        try {
            Continuation continuationB = c.b(c.a(function2, r, continuation));
            Result.a aVar = Result.f25108f;
            i.b(continuationB, Result.a(u.a), function1);
        } catch (Throwable th) {
            a(continuation, th);
        }
    }

    public static /* synthetic */ void d(Function2 function2, Object obj, Continuation continuation, Function1 function1, int i2, Object obj2) throws Throwable {
        if ((i2 & 4) != 0) {
            function1 = null;
        }
