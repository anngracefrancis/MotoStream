...
public final class b {
    public static final <R, T> void a(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation) {
        ...
        try {
            ...
            Object objC = i0.c(l, null);
            try {
                Object objInvoke = ((Function2) l0.e(function2, 2)).invoke(r, continuationA);
                i0.a(l, objC);
                if (objInvoke != d.c()) {
                    Result.a aVar = Result.f25108f;
                    continuationA.resumeWith(Result.a(objInvoke));
                }
            } catch (Throwable th) {
                i0.a(l, objC);
                throw th;
            ...
            continuationA.resumeWith(Result.a(o.a(th2)));
        }
    }
    ...
    public static final <T, R> Object b(ScopeCoroutine<? super T> scopeCoroutine, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        if (completedExceptionally != d.c() && (objF0 = scopeCoroutine.f0(completedExceptionally)) != g2.f25772b) {
            if (!(objF0 instanceof CompletedExceptionally)) {
                return g2.h(objF0);
            }
            Throwable th2 = ((CompletedExceptionally) objF0).f25646b;
            Continuation<? super T> continuation = scopeCoroutine.f25792h;
            if (s0.d() && (continuation instanceof CoroutineStackFrame)) {
                throw d0.j(th2, (CoroutineStackFrame) continuation);
            }
            throw th2;
        }
        return d.c();
