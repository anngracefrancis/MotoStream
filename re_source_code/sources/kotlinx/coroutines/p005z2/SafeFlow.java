...
/* JADX INFO: renamed from: kotlinx.coroutines.z2.l, reason: from Kotlin metadata */
...
final class SafeFlow<T> extends AbstractFlow<T> {
    ...
    @Override // kotlinx.coroutines.p005z2.AbstractFlow
    public Object b(FlowCollector<? super T> flowCollector, Continuation<? super u> continuation) {
        Object objInvoke = this.f25930f.invoke(flowCollector, continuation);
        return objInvoke == d.c() ? objInvoke : u.a;
    }
}
