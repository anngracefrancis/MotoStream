...
public final class Cookie {
    ...
    /* JADX INFO: compiled from: Cookie.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\t\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0019\u0010\u001aJ\u001f\u0010\u0003\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0003\u0010\u0006J\u0015\u0010\u0007\u001a\u00020\u00002\u0006\u0010\u0007\u001a\u00020\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u0015\u0010\t\u001a\u00020\u00002\u0006\u0010\t\u001a\u00020\u0002¢\u0006\u0004\b\t\u0010\bJ\u0015\u0010\u000b\u001a\u00020\u00002\u0006\u0010\u000b\u001a\u00020\n¢\u0006\u0004\b\u000b\u0010\fJ\u0015\u0010\u0003\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0003\u0010\bJ\u0015\u0010\r\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\r\u0010\bJ\u0015\u0010\u000e\u001a\u00020\u00002\u0006\u0010\u000e\u001a\u00020\u0002¢\u0006\u0004\b\u000e\u0010\bJ\r\u0010\u000f\u001a\u00020\u0000¢\u0006\u0004\b\u000f\u0010\u0010J\r\u0010\u0011\u001a\u00020\u0000¢\u0006\u0004\b\u0011\u0010\u0010J\r\u0010\u0013\u001a\u00020\u0012¢\u0006\u0004\b\u0013\u0010\u0014R\u0018\u0010\u0007\u001a\u0004\u0018\u00010\u00028\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0007\u0010\u0015R\u0016\u0010\u0005\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0005\u0010\u0016R\u0018\u0010\t\u001a\u0004\u0018\u00010\u00028\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\t\u0010\u0015R\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0003\u0010\u0015R\u0016\u0010\u000b\u001a\u00020\n8\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u000b\u0010\u0017R\u0016\u0010\u0011\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0011\u0010\u0016R\u0016\u0010\u000e\u001a\u00020\u00028\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u000e\u0010\u0015R\u0016\u0010\u000f\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u000f\u0010\u0016R\u0016\u0010\u0018\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0018\u0010\u0016¨\u0006\u001b"}, d2 = {"Lokhttp3/Cookie$Builder;", HttpUrl.FRAGMENT_ENCODE_SET, HttpUrl.FRAGMENT_ENCODE_SET, "domain", HttpUrl.FRAGMENT_ENCODE_SET, "hostOnly", "(Ljava/lang/String;Z)Lokhttp3/Cookie$Builder;", "name", "(Ljava/lang/String;)Lokhttp3/Cookie$Builder;", "value", HttpUrl.FRAGMENT_ENCODE_SET, "expiresAt", "(J)Lokhttp3/Cookie$Builder;", "hostOnlyDomain", "path", "secure", "()Lokhttp3/Cookie$Builder;", "httpOnly", "Lokhttp3/Cookie;", "build", "()Lokhttp3/Cookie;", "Ljava/lang/String;", "Z", "J", "persistent", "<init>", "()V", "okhttp"}, k = 1, mv = {1, 4, 0})
    public static final class Builder {
        ...
        public final Builder name(String name) {
            m.f(name, "name");
            if (!m.a(v.O0(name).toString(), name)) {
        ...
        public final Builder value(String value) {
            m.f(value, "value");
            if (!m.a(v.O0(value).toString(), value)) {
    ...
    public static final class Companion {
        ...
        public final boolean domainMatch(String urlHost, String domain) {
            ...
            return u.p(urlHost, domain, false, 2, null) && urlHost.charAt((urlHost.length() - domain.length()) - 1) == '.' && !Util.canParseAsIpAddress(urlHost);
        }

        private final String parseDomain(String s) {
            if (!(!u.p(s, ".", false, 2, null))) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            String canonicalHost = HostnamesKt.toCanonicalHost(v.m0(s, "."));
            if (canonicalHost != null) {
        ...
        private final long parseExpires(String s, int pos, int limit) {
            ...
            while (iDateCharacterOffset < limit) {
                ...
                if (i3 == -1 && matcher.usePattern(Cookie.TIME_PATTERN).matches()) {
                    ...
                    m.e(strPattern, "MONTH_PATTERN.pattern()");
                    iW = v.W(strPattern, lowerCase, 0, false, 6, null) / 4;
                } else if (i2 == -1 && matcher.usePattern(Cookie.YEAR_PATTERN).matches()) {
                    String strGroup6 = matcher.group(1);
                    m.e(strGroup6, "matcher.group(1)");
        ...
        private final long parseMaxAge(String s) {
            try {
                ...
                if (new Regex("-?\\d+").b(s)) {
                    return u.E(s, "-", false, 2, null) ? Long.MIN_VALUE : Long.MAX_VALUE;
                }
                throw e2;
            }
        }
        ...
        public final boolean pathMatch(HttpUrl url, String path) {
            ...
            if (m.a(strEncodedPath, path)) {
                return true;
            }
            return u.E(strEncodedPath, path, false, 2, null) && (u.p(path, "/", false, 2, null) || strEncodedPath.charAt(path.length()) == '/');
        }
        ...
        public final Cookie parse$okhttp(long currentTimeMillis, HttpUrl url, String setCookie) {
            ...
            while (i2 < length) {
                ...
                String strTrimSubstring3 = iDelimiterOffset2 < iDelimiterOffset ? Util.trimSubstring(setCookie, iDelimiterOffset2 + 1, iDelimiterOffset) : HttpUrl.FRAGMENT_ENCODE_SET;
                if (u.q(strTrimSubstring2, "expires", true)) {
                    try {
                        expires = parseExpires(strTrimSubstring3, 0, strTrimSubstring3.length());
                        z3 = true;
                    } catch (NumberFormatException | IllegalArgumentException unused) {
                    }
                } else if (u.q(strTrimSubstring2, "max-age", true)) {
                    maxAge = parseMaxAge(strTrimSubstring3);
                    z3 = true;
                } else if (u.q(strTrimSubstring2, "domain", true)) {
                    domain = parseDomain(strTrimSubstring3);
                    z4 = false;
                } else if (u.q(strTrimSubstring2, "path", true)) {
                    str3 = strTrimSubstring3;
                } else if (u.q(strTrimSubstring2, "secure", true)) {
                    z = true;
                } else if (u.q(strTrimSubstring2, "httponly", true)) {
                    z2 = true;
                }
            ...
            if (maxAge == Long.MIN_VALUE) {
                ...
                j4 = currentTimeMillis + (maxAge <= 9223372036854775L ? maxAge * ((long) 1000) : Long.MAX_VALUE);
            ...
            String strSubstring = "/";
            String str4 = str3;
            if (str4 == null || !u.E(str4, "/", false, 2, cookie)) {
                String strEncodedPath = url.encodedPath();
                int iA0 = v.a0(strEncodedPath, '/', 0, false, 6, null);
                if (iA0 != 0) {
        ...
        public final List<Cookie> parseAll(HttpUrl url, Headers headers) {
            ...
            m.e(listUnmodifiableList, "Collections.unmodifiableList(cookies)");
    ...
    public final boolean matches(HttpUrl url) {
        m.f(url, "url");
        if ((this.hostOnly ? m.a(url.host(), this.domain) : INSTANCE.domainMatch(url.host(), this.domain)) && INSTANCE.pathMatch(url, this.path)) {
