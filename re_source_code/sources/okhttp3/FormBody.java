...
public final class FormBody extends RequestBody {
    ...
    private final long writeOrCountBytes(g sink, boolean countBytes) throws EOFException {
        f fVarI;
        if (countBytes) {
            fVarI = new f();
        } else {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            fVarI.r0(this.encodedNames.get(i2));
            fVarI.writeByte(61);
            fVarI.r0(this.encodedValues.get(i2));
        }
        if (!countBytes) {
            return 0L;
        }
        long size2 = fVarI.size();
        fVarI.b();
        return size2;
    }
