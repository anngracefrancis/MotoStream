...
public final class Response implements Closeable {
    ...
    public final ResponseBody peekBody(long byteCount) throws IOException {
        ...
        f fVar = new f();
        hVarPeek.request(byteCount);
        fVar.x0(hVarPeek, Math.min(byteCount, hVarPeek.i().size()));
