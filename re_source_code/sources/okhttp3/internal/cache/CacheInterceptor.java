...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if ((!u.q("Warning", strName, true) || !u.E(strValue, "1", false, 2, null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isContentSpecificHeader(String fieldName) {
            return u.q("Content-Length", fieldName, true) || u.q("Content-Encoding", fieldName, true) || u.q("Content-Type", fieldName, true);
        }

        private final boolean isEndToEnd(String fieldName) {
            return (u.q("Connection", fieldName, true) || u.q("Keep-Alive", fieldName, true) || u.q("Proxy-Authenticate", fieldName, true) || u.q("Proxy-Authorization", fieldName, true) || u.q("TE", fieldName, true) || u.q("Trailers", fieldName, true) || u.q("Transfer-Encoding", fieldName, true) || u.q("Upgrade", fieldName, true)) ? false : true;
        }
    ...
    private final Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        final h bodySource = responseBodyBody.getBodySource();
        final j.g gVarC = q.c(body);
        d0 d0Var = new d0() { // from class: okhttp3.internal.cache.CacheInterceptor$cacheWritingResponse$cacheWritingSource$1
            ...
            public long read(f sink, long byteCount) throws IOException {
                ...
                try {
                    ...
                    if (j2 != -1) {
                        sink.j(gVarC.i(), sink.size() - j2, j2);
                        gVarC.c0();
                        return j2;
                    }
