...
public final class Http2 {
    ...
    static {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            ...
            strArr[i2] = u.z(Util.format("%8s", binaryString), ' ', '0', false, 4, null);
        }
        BINARY = strArr;
    ...
    public final String formatFlags(int type, int flags) {
        ...
        if (type != 2 && type != 3) {
            ...
            if (type != 7 && type != 8) {
                ...
                String str2 = str;
                if (type != 5 || (flags & 4) == 0) {
                    return (type != 0 || (flags & 32) == 0) ? str2 : u.A(str2, "PRIORITY", "COMPRESSED", false, 4, null);
                }
                return u.A(str2, "HEADERS", "PUSH_PROMISE", false, 4, null);
            }
        }
        return BINARY[flags];
    }
