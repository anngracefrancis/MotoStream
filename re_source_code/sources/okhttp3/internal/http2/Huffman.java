...
public final class Huffman {
    ...
    public final void decode(h source, long byteCount, g sink) throws IOException {
        m.f(source, "source");
        m.f(sink, "sink");
        Node node = root;
        int iAnd = 0;
    ...
    public final void encode(i source, g sink) throws IOException {
        ...
        for (int i3 = 0; i3 < iP; i3++) {
            int iAnd = Util.and(source.x(i3), 255);
            int i4 = CODES[iAnd];
    ...
    public final int encodedLength(i bytes) {
        ...
        for (int i2 = 0; i2 < iP; i2++) {
            j2 += (long) CODE_BIT_COUNTS[Util.and(bytes.x(i2), 255)];
        }
        return (int) ((j2 + ((long) 7)) >> 3);
    }

    /* JADX INFO: compiled from: Huffman.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0010\u0011\n\u0002\b\t\b\u0002\u0018\u00002\u00020\u0001B\t\b\u0016¢\u0006\u0004\b\u000e\u0010\u000fB\u0019\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0010\u001a\u00020\u0002¢\u0006\u0004\b\u000e\u0010\u0011R\u0019\u0010\u0003\u001a\u00020\u00028\u0006@\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R\u0019\u0010\u0007\u001a\u00020\u00028\u0006@\u0006¢\u0006\f\n\u0004\b\u0007\u0010\u0004\u001a\u0004\b\b\u0010\u0006R#\u0010\n\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\u0000\u0018\u00010\t8\u0006@\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\r¨\u0006\u0012"}, d2 = {"Lokhttp3/internal/http2/Huffman$Node;", HttpUrl.FRAGMENT_ENCODE_SET, HttpUrl.FRAGMENT_ENCODE_SET, "symbol", "I", "getSymbol", "()I", "terminalBitCount", "getTerminalBitCount", HttpUrl.FRAGMENT_ENCODE_SET, "children", "[Lokhttp3/internal/http2/Huffman$Node;", "getChildren", "()[Lokhttp3/internal/http2/Huffman$Node;", "<init>", "()V", "bits", "(II)V", "okhttp"}, k = 1, mv = {1, 4, 0})
