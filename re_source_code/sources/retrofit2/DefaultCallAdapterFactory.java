...
final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        class AnonymousClass1 implements Callback<T> {
            ...
            /* JADX INFO: renamed from: lambda$onFailure$1, reason: merged with bridge method [inline-methods] */
            public /* synthetic */ void a(Callback callback, Throwable th) {
                callback.onFailure(ExecutorCallbackCall.this, th);
            }

            /* JADX INFO: Access modifiers changed from: private */
            /* JADX INFO: renamed from: lambda$onResponse$0, reason: merged with bridge method [inline-methods] */
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.b
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f25981f.b(callback, response);
                    }
                });
            }
        }
